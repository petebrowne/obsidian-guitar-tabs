...
- Entry point: `main.tsx` compiled to `main.js` and loaded by Obsidian.
...
- To check and fix issues, run: `npm run lint`
- To automatically fix errors and format code, run: `npm run format`
- You can configure options in the `biome.json` config file.
